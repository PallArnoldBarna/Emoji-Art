...
//  Emoji Art
//
//  Created by Páll Arnold-Barna on 26.03.2024.
//
...
struct EmojiArtDocumentView: View {
    ...
    private let palettEmojiSize: CGFloat = 40
    
    var body: some View {
        VStack(spacing: 0) {
            documentBody
            PaletteChooser()
                .font(.system(size: palettEmojiSize))
                .padding(.horizontal)
